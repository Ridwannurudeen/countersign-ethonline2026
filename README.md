...
topics. The guard's topic-creation history contains 12 topics; these six hold verdicts.
...
- [Topic `0.0.10511981` (sandbox)](https://testnet.mirrornode.hedera.com/api/v1/topics/0.0.10511981/messages)
